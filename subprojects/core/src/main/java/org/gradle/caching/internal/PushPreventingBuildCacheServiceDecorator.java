...
public class PushPreventingBuildCacheServiceDecorator extends AbstractRoleAwareBuildCacheServiceDecorator {
    private static final Logger LOGGER = LoggerFactory.getLogger(PushPreventingBuildCacheServiceDecorator.class);

    public PushPreventingBuildCacheServiceDecorator(RoleAwareBuildCacheService delegate) {
        super(delegate);
    }
